...
plt.title("GA " + " O2[%]: " + str(A0) + "  CO2[%]: " + str(A2), fontsize=10) # To display 0 initially. Will be updated 
...
try:
    while True:     
        ...
        A0 = round(((((adc.read_adc(0, 1)*0.000125)*41,6666667)-25),4)#O2 [%]
        A1 = round((adc.read_adc(1, 1)/2),0)
        A2 = round(((((adc.read_adc(2, 1)*0.000125)*41,6666667)-25),4)#CO2 [%]
        ...
        #y4.append(A3)
        # ..update plot..
        plt.title("GA " + " O2[%]: " + str(A0) + "  CO2[%]: " + str(A2), fontsize=10)
